...
public class UserListPanel extends JPanel {
    ...
    // Add this method to update the style of muted users
    protected void updateUserListStyle() {
        Component[] cs = userListArea.getComponents();
        for (Component c : cs) {
            if (c instanceof JEditorPane) {
                JEditorPane textContainer = (JEditorPane) c;
                // Assuming you have a method isMuted() in your User class
                // You need to update this logic based on your actual data structure for users
    ...
    public void recentUser(long clientId) {
        updateUserListStyle(); // Call this method after adding or removing users
        Component[] cs = userListArea.getComponents();
        for (Component c : cs) {
