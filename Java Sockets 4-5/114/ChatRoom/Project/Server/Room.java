        ...
        try {
            if (message.startsWith(COMMAND_TRIGGER)) {
                ...
                //UCID:NS87 DATE:04.1.24     
                    ...
                    if (coin == 0) {
                    sendMessage(null, String.format("<b>%s did a coin flip and had Heads</b>", client.getClientName()));
                     } else if (coin == 1) {
                    sendMessage(null, String.format("<b>%s did a coin flip and had on Tails</b>", client.getClientName()));
                     }
                    break;
                ...
                //UCID:NS87 DATE:04.1.24     
                    ...
                    client.sendMessage(-1, "<b>invalid input</b>");
                    }
